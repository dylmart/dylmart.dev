...
"use strict";
    ...
    radius = .25;
    "16";
    cylinder_bounds = ρσ_interpolate_kwargs.call(this, cylinder, [ρσ_desugar_kwargs({pos: vec(1["-u"]()["*"](15), 0, 0), axis: vec(30, 0, 0), radius: 7.5, color: color.cyan, opacity: .05})]);
    "21";
    ring1 = ρσ_interpolate_kwargs.call(this, ring, [ρσ_desugar_kwargs({pos: vec(1["-u"]()["*"](15), 0, 0), radius: 7.5, thickness: radius, color: color.cyan})]);
    "25";
    ring2 = ρσ_interpolate_kwargs.call(this, ring, [ρσ_desugar_kwargs({pos: vec(15, 0, 0), radius: 7.5, thickness: radius, color: color.cyan})]);
    "29";
    line1 = ρσ_interpolate_kwargs.call(this, cylinder, [ρσ_desugar_kwargs({pos: vec(1["-u"]()["*"](15), 1["-u"]()["*"](7.5), 0), axis: vec(30, 0, 0), radius: radius, color: color.cyan})]);
    "33";
    line2 = ρσ_interpolate_kwargs.call(this, cylinder, [ρσ_desugar_kwargs({pos: vec(1["-u"]()["*"](15), 7.5, 0), axis: vec(30, 0, 0), radius: radius, color: color.cyan})]);
    "37";
    line3 = ρσ_interpolate_kwargs.call(this, cylinder, [ρσ_desugar_kwargs({pos: vec(1["-u"]()["*"](15), 0, 7.5), axis: vec(30, 0, 0), radius: radius, color: color.cyan})]);
    "41";
    line3 = ρσ_interpolate_kwargs.call(this, cylinder, [ρσ_desugar_kwargs({pos: vec(1["-u"]()["*"](15), 0, 1["-u"]()["*"](7.5)), axis: vec(30, 0, 0), radius: radius, color: color.cyan})]);
    "48";
    POIs = ρσ_list_decorate([]);
    "49";
    for (var ρσ_Index1 = .1; ρσ_Index1["<"](1); ρσ_Index1=ρσ_Index1["+"](.1)) {
        i = ρσ_Index1;
        "50";
    ...
    for (var ρσ_Index2 of ρσ_Iter2) {
        theta = ρσ_Index2;
        "69";
        segment = ρσ_interpolate_kwargs.call(this, cylinder, [ρσ_desugar_kwargs({pos: vec(coil_left, coil_radius["*"](cos(theta)), coil_radius["*"](sin(theta))), axis: coil_radius["*"](d_theta)["*"](vec(0, 1["-u"]()["*"](sin(theta["+"](d_theta))), cos(theta["+"](d_theta)))), radius: .5, color: color.orange, opacity: .35})]);
        "74";
    ...
    "87";
    var ρσ_Iter3 = range(0, 1["-u"]()["*"](theta_total), 1["-u"]()["*"](d_theta));
    ρσ_Iter3 = ((typeof ρσ_Iter3[Symbol.iterator] === "function") ? (ρσ_Iter3 instanceof Map ? ρσ_Iter3.keys() : ρσ_Iter3) : Object.keys(ρσ_Iter3));
    for (var ρσ_Index3 of ρσ_Iter3) {
        theta = ρσ_Index3;
        "89";
        segment = ρσ_interpolate_kwargs.call(this, cylinder, [ρσ_desugar_kwargs({pos: vec(coil_right, coil_radius["*"](cos(theta)), coil_radius["*"](sin(theta))), axis: coil_radius["*"](d_theta)["*"](vec(0, 1["-u"]()["*"](sin(theta["-"](1["*"](d_theta)))), cos(theta["-"](1["*"](d_theta))))), radius: .5, color: color.orange, opacity: .35})]);
        "94";
        segment.ds = segment.axis;
        "95";
        segment.center = segment.pos["+"](.5["*"](segment.ds));
    ...
    while (true) {
        ...
        for (var ρσ_Index8 of ρσ_Iter8) {
            ...
            if ((POI.inside === true || typeof POI.inside === "object" && ρσ_equals(POI.inside, true))) {
                ...
                "165";
                if (7.5["<"](mag(vec(0, POI.pos.y, POI.pos.z))) || POI.pos.x[">"](15) || POI.pos.x["<"](1["-u"]()["*"](15))) {
                    "166";
                    print("I: "["+"](POI.current)["+"]("A t: ")["+"](t)["+"]("s v: ")["+"](POI.velocity.mag)["+"]("m/s"));
                    "167";
