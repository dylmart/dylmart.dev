...
rock1 = sphere(color = color.white, radius = 2.0, make_trail=False, texture='https://i.imgur.com/ns7Q3s6.jpeg')
rock2 = sphere(color = color.white, radius = 0.8, make_trail=True, interval=20, retain=35, trail_type='points', texture='https://i.imgur.com/7XyId7s.jpeg')
...
rock2.v = vec(starting_v,0,0)       #units m/s
...
while (True):
    ...
    rock1.rotate(angle=rotAngle, axis=rotYAxis)
    rock2.rotate(angle=rotAngle+rotAngle, axis=rotYAxis)
