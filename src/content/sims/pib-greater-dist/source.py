...
#box
radius = 0.25
cylinder_bounds = cylinder(pos = vec(-25,0,0),
                           axis  = vec(50,0,0),
                           radius = 10,
                           color = color.cyan,
                           opacity = 0.05)
ring1 = ring(pos = vec(-25,0,0),
             radius = 10,
             thickness = radius,
             color = color.cyan)
ring2 = ring(pos = vec(25,0,0),
             radius = 10,
             thickness = radius,
             color = color.cyan)             
line1 = cylinder(pos = vec(-25,-10,0),
                 axis = vec(50,0,0),
                 radius = radius,
                 color = color.cyan)
line2 = cylinder(pos = vec(-25,10,0),
                 axis = vec(50,0,0),
                 radius = radius,
                 color = color.cyan)   
line3 = cylinder(pos = vec(-25,0,10),
                 axis = vec(50,0,0),
                 radius = radius,
                 color = color.cyan)
line3 = cylinder(pos = vec(-25,0,-10),
...
while True:
    ...
    for POI in POIs:
        if POI.inside == True:
            ...
            if 10 < mag(vec(0,POI.pos.y,POI.pos.z)) or POI.pos.x > 25 or POI.pos.x < -25:
